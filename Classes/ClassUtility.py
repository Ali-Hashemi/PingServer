...
class Print:
    ...
    def print_black(value):
        print(CustomColor.BLACK + str(value), end='')

    @staticmethod
    def print_white(value):
        print(CustomColor.WHITE + str(value), end='')

    @staticmethod
    def print_red(value):
        print(CustomColor.RED + str(value), end='')

    @staticmethod
    def print_yellow(value):
        print(CustomColor.YELLOW + str(value), end='')

    @staticmethod
    def print_green(value):
        print(CustomColor.GREEN + str(value), end='')

    @staticmethod
    def print_cyan(value):
        print(CustomColor.CYAN + str(value), end='')

    @staticmethod
    def print_blue(value):
        print(CustomColor.BLUE + str(value), end='')
